...
RSpec.describe OAuthService do
  describe "#new_token" do
    context "endpoint returns 200" do
      it "gets a new token from the OAuth server" do
        stub_libanswers_oauth
    ...
    context "endpoint returns non-200" do
      it "errors" do
        ...
        expect { service.new_token }.to raise_error(OAuthService::CouldNotGenerateOAuthToken)
      end
    end
  end
