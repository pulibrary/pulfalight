export default class {
  ...
  addLoginLink() {
    ...
    readingRoom.innerHTML = "<p>Please contact Special Collections staff through the <%= link_to "Ask Us! form", "https://library.princeton.edu/special-collections/ask-us" %> for access to this collection. <button id='login' class='btn' >Use your Princeton credentials to login.</button></p>";
