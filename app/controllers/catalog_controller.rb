...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_sort_field "box_folder_sort_si asc", label: "box & folder number (ascending)", if: :collection_facet_selected?
    config.add_sort_field "box_folder_sort_si desc", label: "box & folder number (descending)", if: :collection_facet_selected?
    ...
    config.add_component_field "userestrict_ssm", label: "Conditions for Reproduction and Use", helper_method: :paragraph_separator, accessor: :fetch_html_safe
    ...
    config.add_component_field "custodhist_ssm", label: "Custodial History", helper_method: :paragraph_separator, accessor: :fetch_html_safe
    ...
    config.add_component_field "names_structured_ssm", label: "Names", helper_method: :structured_names_helper
  ...
  def collection_facet_selected?
    params.dig(:f, :collection_sim).present?
  end
end
